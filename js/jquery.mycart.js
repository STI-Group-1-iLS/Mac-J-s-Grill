  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"> <div class="wowow"> <center> <span class="glyphicon glyphicon-shopping-cart"></span>  My Cart <center/> </div> <br> <div class="wow">(Please take a screenshot of your cart and contact the page) </div>  </h4>' +
        '</div>' +
